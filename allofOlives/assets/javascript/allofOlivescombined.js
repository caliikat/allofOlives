            ...
            method: "GET"
                ...
                for (var i = 0; i < recipes.length; i++) {
                    ...
                    $.ajax({
                        ...
                        ingr: recipeObject.recipe.ingredientLines
                    ...
                    $(".carousel").append(newItem);
                        ...
                        $(".carousel-item>img").on("dblclick", function(){
                            console.log('clicked');
                            console.log(this);
...
///////////////////////////////////////////////////////////////
    ...
    //When user pressed "enter", the same function will run as if they clicked the button
